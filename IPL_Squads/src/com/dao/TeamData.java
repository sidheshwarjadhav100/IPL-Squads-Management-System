...
//		String name; int jrcyNo; String teamName; int runs; int wickets; int matches;
		...
		Player p1 = new Player("MS Dhoni", 7, "CSK", 6434, 3, 487);
		Player p2 = new Player("Ruturaj Gaikwad", 7, "CSK", 6434, 3, 487);
		Player p3 = new Player("Ravindra Jadeja", 7, "CSK", 6434, 3, 487);
		Player p4 = new Player("Shivam Dube", 7, "CSK", 6434, 3, 487);
		Player p5 = new Player("Richand Gleeson", 7, "CSK", 6434, 3, 487);
		Player p6 = new Player("Rajvirdhn Hangarekar", 7, "CSK", 6434, 3, 487);

		Player p7 = new Player("Rishabh Pant", 54, "DC", 4534, 2, 127);
		Player p8 = new Player("Davi Warner", 18, "DC", 5434, 12, 127);
		Player p9 = new Player("Axar Patel", 43, "DC", 3456, 65, 234);
		Player p10 = new Player("Lalit Yadav", 7, "DC", 6434, 3, 487);
		Player p11 = new Player("Pravin Dubey", 7, "DC", 6434, 3, 487);
		Player p12 = new Player("Kuldeep Yadav", 7, "DC", 6434, 3, 487);
		...
		Player p[] = { p1, p2, p3, p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,
				p31,p32,p34,p35,p36,p37,p38,p39,p40,p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59,p60};
